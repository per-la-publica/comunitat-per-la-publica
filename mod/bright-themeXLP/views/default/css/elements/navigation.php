...
.elgg-pagination a, .elgg-pagination span {
  ...
  background-color: #fff;
	border: 1px solid #ff6309; /*#28f;*/
	color: #6b0094; /*#28f;*/
}
.elgg-pagination a:hover {
	background-color:#ff6309; /*#28f;*/
  border-color: #6b0094; /*#6b0094; /*#6b0094; /*#05d;*/*/;*/
	color: #fff;
...
.elgg-menu-site-default > li:hover > a {
	background: #fff url(<?php echo elgg_get_site_url(); ?>mod/bright-themeXLP/graphics/menu-button.png) repeat-x left top;
	color: #6b0094; /*#6b0094; /*#6b0094; /*#05d;*/*/;*/
...
.elgg-menu-site-more > li > a:hover {
  border-color: #03b;
	background: #6b0094; /*#6b0094; /*#6b0094; /*#05d;*/*/;*/
	color: #fff;
}
