<?php
     ...
     */
    function xlp_filter_upc_address_information($hook, $type, $returnvalue, $params) {
     ...
     */
    function xlp_filter_upc_address($hook, $type, $returnvalue, $params) { 
     ...
     */
    function xlp_save_initial_email($hook, $type, $value, $params) {
